...
-- CREATING DIMENSION CUSTOMERS(Dimension for the object -Customer)
-- ===========================================================================================
...
SELECT 
	...
	la.cntry AS country,
	ci.cst_martital_status marital_status,
	CASE 
...
LEFT JOIN silver.erp_px_cat_g1v2 pc 
	ON pn.cat_id = pc.id
WHERE prd_end_dt IS NULL -- Filter out all history data
GO
